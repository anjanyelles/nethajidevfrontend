...
const Registration = () => {
  ...
  and Start Learning with Access to Quality Courses
</h3>
  ...
  Empower Your Future with Quality Education at Nethaji Degree College — Learn from Anywhere, Succeed Everywhere.
</p>
